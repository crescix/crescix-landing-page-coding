      ...
      <div className="max-w-3xl mx-auto px-5 md:px-8 py-10 md:py-16">
        ...
        <article className="space-y-8 text-[15px] leading-relaxed text-white/75">
          ...
          <Section titulo="1. O serviço">
            <p>
              CrescIX é uma plataforma web e um bot Telegram pra gestão
              financeira de pequenos negócios. Permite registrar vendas,
              despesas, compras, gerar relatórios e ver análises geradas
              por IA.
            </p>
          </Section>
          ...
          <Section titulo="2. Sua conta">
            <Ul>
              <li>
                Você precisa ter pelo menos 18 anos e poder celebrar
                contratos pra criar uma conta.
              </li>
              <li>
                Os dados informados no cadastro devem ser verdadeiros e
                atualizados.
              </li>
              <li>
                Você é responsável por manter sua senha em segredo. Tudo
                que acontecer na sua conta é de sua responsabilidade.
              </li>
              <li>
                Se notar acesso indevido, comunique imediatamente pelo
                e-mail de suporte.
              </li>
              <li>
          ...
          <Section titulo="3. Uso permitido">
            <p className="mb-3">
              Você pode usar a CrescIX pra registrar e analisar as
              finanças do seu negócio. Não pode usar pra:
            </p>
            <Ul>
              <li>
                Atividades ilegais ou que ferem direitos de terceiros.
              </li>
              <li>
                Tentar acessar dados de outros usuários, fazer engenharia
                reversa do app ou explorar falhas de segurança sem
                autorização.
              </li>
              <li>
              ...
              <li>
                Revender ou repassar acesso à plataforma sem autorização
                nossa por escrito.
              </li>
            </Ul>
            <p className="mt-3">
              Violar essas regras nos dá o direito de suspender ou
              encerrar sua conta sem reembolso.
            </p>
          </Section>

          <Section titulo="4. Seus dados são seus">
            <p>
              Tudo que você cadastra na CrescIX (fornecedores, clientes,
              produtos, lançamentos) pertence a você. Você pode exportar
              a qualquer momento e, ao encerrar a conta, todos os seus
              dados são apagados (veja a{" "}
              <button
          ...
          <Section titulo="5. Pagamento">
            <p>
              Durante a fase atual (beta), o uso da CrescIX é gratuito.
              Quando passarmos a cobrar, avisaremos com pelo menos 30
              dias de antecedência por e-mail, e você poderá optar por
              encerrar a conta sem qualquer custo.
            </p>
          </Section>

          <Section titulo="6. Disponibilidade">
            <p>
              A gente faz o que está ao nosso alcance pra manter o
              serviço no ar, mas não garantimos disponibilidade
              ininterrupta. Manutenções programadas serão avisadas com
              antecedência quando possível. Eventuais quedas curtas e
          ...
          <Section titulo="8. Limitação de responsabilidade">
            <Ul>
              <li>
                A CrescIX é fornecida "como está". Fazemos o melhor que
                podemos, mas não garantimos que vai atender a todos os
                seus objetivos.
              </li>
              <li>
                Não nos responsabilizamos por decisões de negócio que
                você tomar com base nos relatórios e análises da
                plataforma.
              </li>
              <li>
              ...
              <li>
                Nossa responsabilidade financeira fica limitada ao valor
                que você pagou pelo serviço nos 12 meses anteriores ao
                incidente (no beta gratuito, esse limite é zero).
              </li>
            </Ul>
          </Section>
          ...
          <Section titulo="9. Encerramento">
            <p>
              Você pode encerrar sua conta a qualquer momento enviando
              e-mail pra{" "}
              <a
          ...
          <Section titulo="10. Atualizações destes termos">
            <p>
              Podemos atualizar estes termos. Quando a mudança for
              significativa, te avisamos por e-mail e na interface antes
              da nova versão entrar em vigor. Se você continuar usando o
              serviço após a mudança, considera-se que aceitou.
            </p>
          </Section>

          <Section titulo="11. Foro">
            <p>
              Fica eleito o foro da comarca de Santa Rita do Sapucaí, MG,
              pra dirimir qualquer questão originada destes termos, com
...
// ─── Primitivas (mesmas da página de privacidade) ─────────────────────────
