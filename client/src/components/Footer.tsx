...
export default function Footer() {
  return (
    <footer className="bg-[#172A3A] text-white py-16 relative overflow-hidden">
      {/* Decorative */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#09636B]/30 to-transparent" />
      ...
      <div className="container relative z-10">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <a href="#inicio" className="flex items-center gap-2 mb-4">
              <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-[#09636B] to-[#004346] flex items-center justify-center">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["Como Funciona", "Recursos", "Preços", "Integrações"].map((item) => (
                <li key={item}>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <span className="text-sm text-white/30">Feito com IA para o seu negócio</span>
          </div>
        </div>
      </div>
    </footer>
